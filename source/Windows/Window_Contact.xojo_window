...
Begin sdoWindow Window_Contact
   ...
   Begin PushButton PushButton_createContact
      ...
      Width           =   30
   End
   Begin mdLabel Label_SecondPhone
      AutoDeactivate  =   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
      ...
      Width           =   100
   End
   Begin mdTextField TextField_SecondPhone
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
      AutomaticallyCheckSpelling=   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub myOpen(pWindowMode as integer)
		  ...
		  // TextField_Phone2
		  TextField_SecondPhone.mdTableName = "contacts"
		  TextField_SecondPhone.mdFieldName = "phoneareacode"
		  TextField_SecondPhone.mdFormat = 0
		  TextField_SecondPhone.mdpkFieldName ="pkid"
